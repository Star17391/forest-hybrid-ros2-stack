...
FOREST_CLI_TOP_LEVEL="status down cleanup up capture world profile panel teleop attach test diag logs completion help -h --help"
FOREST_CLI_CAPTURE_OPTS="--profile --out --poll --stall --no-down -h --help"
